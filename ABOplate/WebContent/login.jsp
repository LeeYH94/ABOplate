        ...
        <div class="row block-9 justify-content-center mb-5">
          <div class="col-md-8 mb-md-5">
            ...
            <form action="#" class="bg-light p-5 contact-form">
              ...
              <div class="d-flex justify-content-center">
              	<div class=".a-login">
              		<a href="find_id.html" style="margin:5px;">아이디 찾기</a>
	                <a href="find_id.html/pills-manufacturer" style="margin:5px;">비밀번호 찾기</a>
	                <a href="about.html" style="margin:5px;">회원가입</a>
              	</div>
              	</div>
              </div>
