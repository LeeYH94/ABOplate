	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        ...
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="agent.jsp" class="nav-link">★ 포인트</a></li>
	          ...
	          <li class="nav-item"><a onClick="javascript:goDetail('테스트');" class="nav-link">최근 본 맛집</a></li>
				...
				<div class="col-md-12 pills">
					<div class="bd-example bd-example-tabs">
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="form-group">
								<div class="d-flex justify-content-center">
									<input type="button" value="수정"  style="margin-right:10px !important;" class="btn btn-primary py-3 p=x-5" onclick="location.href='InformationModify.jsp'" >
