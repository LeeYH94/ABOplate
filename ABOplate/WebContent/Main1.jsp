					...
					<div class="bd-example bd-example-tabs">
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade" id="pills-manufacturer"
								...
								<div class="row">
									<div style="margin: 0 auto;">
										<h5>로그인(회원가입)을 하시면 맞춤 맛집을 추천해드립니다</h5>
										<div class="justify-content-center" style="margin-left: 85px;">
											<input style="width: 40%;" type="button" value="로그인"
												class="btn btn-primary py-3 px-5"
												onClick="location.href='login.html'"> <input
												style="width: 40%;" type="button" value="회원가입"
												class="btn btn-primary py-3 px-5"
